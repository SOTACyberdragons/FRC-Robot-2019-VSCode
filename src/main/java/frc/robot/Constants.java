...
public class Constants {
	...
	public static enum AutoChoice {DO_NOT_MOVE, DRIVE_STRAIGHT_20_INCHES, 
		DRIVE_STRAIGHT_50_INCHES, TRAJECTORY_TEST, 
		LEFT_CENTER_HATCH, RIGHT_CENTER_HATCH, LEFT_FARTCH_CARGO, 
		RIGHT_FARTCH_CARGO, LEFT_FARTCH_CARGO_DOUBLE,
		RIGHT_FARTCH_CARGO_DOUBLE};
